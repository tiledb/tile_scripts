...
#         feb.set_ped_HG_pos(md, 0, feb_id, min_DAC)
#         feb.set_ped_HG_neg(md, 0, feb_id, max_DAC)
#         feb.set_ped_LG_pos(md, 0, feb_id, min_DAC)
#         feb.set_ped_LG_neg(md, 0, feb_id, max_DAC)
